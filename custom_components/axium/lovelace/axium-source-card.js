...
AxiumAlarmsCard.styles = `
  ...
  .mediabrowse {
    border: 1px solid var(--divider-color); border-radius: 12px; padding: 6px;
    background: var(--secondary-background-color);
  }
  ...
  .zonechip {
    padding: 7px 14px; border-radius: 999px; border: 1px solid var(--divider-color);
  ...
  .qd {
    ...
    color: var(--secondary-text-color); transition: border-color 0.15s ease;
  }
